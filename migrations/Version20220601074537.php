 ...
 */
final class Version20220601074537 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `user` (id INT AUTO_INCREMENT NOT NULL, possession_id INT DEFAULT NULL, nom VARCHAR(40) NOT NULL, prenom VARCHAR(40) NOT NULL, email VARCHAR(40) NOT NULL, adresse VARCHAR(40) NOT NULL, tel VARCHAR(40) NOT NULL, birth_date DATETIME NOT NULL, INDEX IDX_8D93D649A337924 (possession_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
